    ...
    <div class="container">
        <div class="row">
            <div class="mx-auto col-md-6 mt-5">
                ...
                {!! Form::open(['route' => 'dashboard.user.store', 'method' => 'post', 'files' => true]) !!}
                ...
                <div class="form-group">
                    <img src="{{ asset('images/default.png') }}" class="img-thumbnail image_preview" style="width: 75px; height: 75px;" alt="">
                </div>
                <div class="form-group">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_1">
                                            ...
                                            @foreach ($params as $param)
                                                <label>
                                                    {!! Form::checkbox('permissions[]', $param.'_users' ) !!}
                                                    {{ ucfirst($param) }}
                                                </label>
                                            @endforeach
                                        </div>
